...
export type SimplesTables = {
  [anexo: string]: TaxFaixa[];
};

export interface PartilhaDistrib {
  IRPJ?: number;
  CSLL?: number;
  CBS?: number;
  CPP?: number;
...
export type PartilhaFaixas = {
  [faixa: number]: PartilhaDistrib;
};

export type PartilhaAnexos = {
  [anexo: string]: PartilhaFaixas;
};

export type SimplesPartilha = {
  [ano: string]: PartilhaAnexos;
};

export const SIMPLES_PARTILHA: SimplesPartilha = {
    "2026": {
        "1": {
...
export const SIMPLES_TABLES: SimplesTables = {
    '1': [ // Anexo I - Comércio
...
export const SIMPLES_TABLES_DEFINITIVA: SimplesTables = {
